...
public class DailyMissionController {
     ...
     */
    @GetMapping("/today")
    public ResponseEntity<DailyMissionResponse> getTodayMission(
     ...
     */
    @PostMapping("/change")
    public ResponseEntity<DailyMissionResponse> changeDailyMission(
            @AuthenticationPrincipal PrincipalDetails principalDetails) {
        String providerId = principalDetails.getUser().getProviderId();
    ...
    public ResponseEntity<DailyMissionResponse> assignDailyMissionsToUserForTest(
